...
function updateFilters() {
    ...
    var shapeElement = d3.select("#shapen");

    // 4b. Save the value that was changed as a variable.

    var dateValue = dateElement.property("value");
    var cityValue = cityElement.property("value");
    var stateValue = statenameElement.property("value");
    ...
    filters= {dateID:dateValue,cityID:cityValue,stateID:stateValue,countryID:countryValue,shapeValue:shapeID}
